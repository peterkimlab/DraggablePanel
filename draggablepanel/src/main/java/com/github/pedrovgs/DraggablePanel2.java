 ...
 */
public class DraggablePanel2 extends FrameLayout {
  ...
  private DraggableView2 draggableView;
  ...
  public DraggablePanel2(Context context) {
    super(context);
  }

  public DraggablePanel2(Context context, AttributeSet attrs) {
    super(context, attrs);
    initializeAttrs(attrs);
  }

  public DraggablePanel2(Context context, AttributeSet attrs, int defStyle) {
  ...
  public void initializeView() {
    ...
    inflate(getContext(), R.layout.draggable_panel2, this);
    draggableView = (DraggableView2) findViewById(R.id.draggable_view);
  ...
  public void setPagingEnabled(boolean tf){
    draggableView.setTouchButtonEnabled(tf);

  }

  public DraggableView2 getDraggableView(){
