 ...
 */
public class DraggableView2 extends RelativeLayout {
  ...
  private boolean touchButtonEnabled = true;
  ...
  public DraggableView2(Context context) {
    super(context);
  }

  public DraggableView2(Context context, AttributeSet attrs) {
    super(context, attrs);
    initializeAttributes(attrs);
  }

  public DraggableView2(Context context, AttributeSet attrs, int defStyle) {
  ...
  private boolean isTouchButtonEnabledEnabled() {
    return this.touchButtonEnabled;
  }
  ...
  public void setTouchButtonEnabled(boolean touchButtonEnabled) {
    this.touchButtonEnabled = touchButtonEnabled;
  }
  ...
  @Override public boolean onInterceptTouchEvent(MotionEvent ev) {
    ...
    if (!isTouchButtonEnabledEnabled()) {
      return false;
    }
  ...
  private void initializeViewDragHelper() {
    viewDragHelper = ViewDragHelper.create(this, SENSITIVITY, new DraggableViewCallback2(this, dragView));
  }

  public void initializeViewDragHelper2() {
    initializeTransformer();
  }
