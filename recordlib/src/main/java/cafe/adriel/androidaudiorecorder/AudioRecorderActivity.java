...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    private ImageButton playSentence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            videoUrl = savedInstanceState.getString(AndroidAudioRecorder.VIDEO_URL);
        } else {
            ...
            videoUrl = getIntent().getStringExtra(AndroidAudioRecorder.VIDEO_URL);
        }
        ...
        playSentence = (ImageButton) findViewById(R.id.playSentence);
    ...
    public void actionPlaySentence(View v) {
        pauseRecording();
        if (isPlaying()) {
            stopPlaying();
        }
    ...
    private void startPlaying(boolean check) {
        try {
            stopRecording();
