...
public class InAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.overridePendingTransition(R.anim.up_in, R.anim.nomove);
        ...
        CardView pay = (CardView)findViewById(R.id.pay);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
			...
			case R.id.launchMoreButton:
				startActivity(new Intent(this, InAppActivity.class).putExtra(ACTIVITY_NUMBER, getIntent().getIntExtra(ACTIVITY_NUMBER, 1) + 1));
				break;
            default:
                break;
        }
    ...
    public void finish() {
        super.finish();
        this.overridePendingTransition(R.anim.nomove, R.anim.up_out);
    }
